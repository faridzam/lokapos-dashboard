<template>
  ...
  >
    ...
    <div class="vertical-nav-header d-flex items-center ps-6 pe-5 pt-5 pb-2">
      <router-link to="/" class="d-flex align-center text-decoration-none">
        ...
        <v-slide-x-transition>
          <h2 class="app-title text--primary">Lokapos</h2>
        </v-slide-x-transition>
      </router-link>
    </div>
    ...
    <v-list expand shaped class="vertical-nav-menu-items pr-5">
      ...
      <nav-menu-group title="Master Data" :icon="icons.mdiDatabaseEditOutline">
        <nav-menu-link title="Stores" :to="{name: 'master-stores'}"></nav-menu-link>
        <nav-menu-link title="Categories" :to="{name: 'master-categories'}"></nav-menu-link>
        <nav-menu-link title="Products" :to="{name: 'master-products'}"></nav-menu-link>
      </nav-menu-group>
      <nav-menu-group title="Stock" :icon="icons.mdiWarehouse" >
        <nav-menu-link title="Suppliers"></nav-menu-link>
        <nav-menu-link title="Raw Materials"></nav-menu-link>
        <nav-menu-link title="Product Ingredients"></nav-menu-link>
        <nav-menu-link title="Product Recipes"></nav-menu-link>
      </nav-menu-group>
      <nav-menu-group title="Reports" :icon="icons.mdiFileChartOutline">
        <nav-menu-link title="Sales Report" :to="{name: 'sales-report'}"></nav-menu-link>
        <nav-menu-link title="Item Sales Report" :to="{name: 'item-sales-report'}"></nav-menu-link>
      </nav-menu-group>
      <nav-menu-link title="Void" :icon="icons.mdiCartRemove"></nav-menu-link>
