      ...
      <v-card class="auth-card">
        ...
        <v-card-title class="d-flex align-center justify-center py-7">
          <router-link to="/" class="d-flex align-center">
            ...
            <h2 class="text-2xl font-weight-semibold">LOKAPOS</h2>
          </router-link>
        </v-card-title>

        <!-- title -->
        <v-card-text>
          <p class="text-2xl font-weight-semibold text--primary mb-2">Let's join our journey 🚀</p>
          <p class="mb-2">Make your LOKAPOS easy and fun!</p>
        </v-card-text>
