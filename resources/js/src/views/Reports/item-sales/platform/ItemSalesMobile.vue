...
export default {
    ...
    methods: {
        //
        getStore(){
            axios.get('/api/get-stores-mobile')
            .then((response)=>{
        ...
        onChangeInput(){
            //
            this.loading = true;
            axios.get('api/get-item-sales-order-mobile/'+this.selectedStore+'/'+this.dateFrom+'/'+this.dateTo)
            .then((response) => {
        ...
        exportSales(){
            //
            window.open('api/export-item-sales-mobile/'+this.selectedStore+'/'+this.dateFrom+'/'+this.dateTo)
            .then((response) => {
                //
                window.close();
            }).catch((error) => {
