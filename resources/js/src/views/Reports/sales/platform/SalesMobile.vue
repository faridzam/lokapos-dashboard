...
export default {
    ...
    methods: {
        ...
        onChangeInput(){
            //
            this.loading = true;
            axios.get('api/get-sales-order-mobile/'+this.selectedStore+'/'+this.dateFrom+'/'+this.dateTo)
            .then((response) => {
        ...
        exportSales(){
            //
            window.open('api/export-sales-mobile/'+this.selectedStore+'/'+this.dateFrom+'/'+this.dateTo)
            .then((response) => {
                //
                window.close();
            }).catch((error) => {
