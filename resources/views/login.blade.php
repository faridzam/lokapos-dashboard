...
@media(max-width: 380px) {
  ...
  <body class="text-center">
    ...
    <div class="wrapper">
        ...
        <div class="text-center mt-4 name"> LOKAPOS </div>
        <form class="p-3 mt-3" action="/login" method="POST">
            @csrf
            <div class="form-field d-flex align-items-center"> <span class="far fa-user"></span> <input class="form-control" type="text" name="username" id="username" placeholder="Username"> </div>
